...
I can't use BeanFactoryPostProcessor and declare them as singletons because the library itself uses @Autowired fields and properties injected dynamically.
